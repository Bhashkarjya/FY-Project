...
describe('Transaction', () => {
    ...
    describe('validTransaction()', () => {
        ...
        describe('when the transaction is invalid', () => {
            ...
            describe('and the input signature is invalid', () => {
                describe('returns false and logs an error',() => {
                    it('returns false and logs an error', () => {
    ...
    describe('update()', () => {
        ...
        describe('and the amount is invalid', () => {
            it('throws an error', () => {
                expect(() => {
                    transaction.update({senderWallet, recipient: 'next-recipient', amount: 999999})
        ...
        describe('and the amount is valid', () => {
            ...
            it('maintains a total output that matches the total input', () => {
                expect(
